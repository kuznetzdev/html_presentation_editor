...
**Current**: v2.0.6 — Layer panel declutter shipped 2026-04-24
(v2.0.0 GA + six post-GA polish tags).
...
plus 6 hardening sprints; the GA has since absorbed 6 user-reported
polish tags (v2.0.1–v2.0.6). All v2 feature flags default to v2
