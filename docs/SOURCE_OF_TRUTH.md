...
**Current**: v2.0.7 — Selection rings polish shipped 2026-04-24
(v2.0.0 GA + seven post-GA polish tags).
...
plus 6 hardening sprints; the GA has since absorbed 7 user-reported
polish tags (v2.0.1–v2.0.7). All v2 feature flags default to v2
