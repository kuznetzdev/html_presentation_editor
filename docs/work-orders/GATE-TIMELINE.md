...
| **v0.37.0-rc.0** (WO-38 RC freeze, 2026-04-22) | **65/5/0** ✅ (measured) | **135/7/0** ✅ chromium-desktop + chromium-shell-1100 (5.5 min) | **28/148/0** ✅ firefox-desktop + webkit-desktop; +1 WebKit timing fix (2.4 min) | **139/60/0** ✅ chromium-mobile-390 + chromium-mobile-640 + chromium-tablet-820 (8 min) | **3/0/0** ✅ (11 sec) | **1410/629/0** ✅ (1.3h, 2026-04-22) | **27/0** ✅ release-enforced | **15/0/0** ✅ release-enforced | **152/0** ✅ release-enforced | **CLEAN** ✅ required (0 errors) |
