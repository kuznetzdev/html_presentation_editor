...
| v2.0.20 | 2026-04-25 | CI workflows: gate-A on every PR + gate-secondary nightly | (pending) | 315/8/0 | New `.github/workflows/gate-a.yml` (typecheck + unit + gate-contract + gate-a matrix Node 18/20/22; Playwright browsers cached) + `gate-secondary.yml` (nightly + manual: gate-B/C/D/E/A11Y/Visual). Phase 7 of 9 |
