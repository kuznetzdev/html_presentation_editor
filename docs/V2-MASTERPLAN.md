...
| v2.0.17 | 2026-04-25 | Performance budget tests | (pending) | 311/8/0 | New fixtures: `perf-200elem.html` (200 absolute divs in 1 slide) + `perf-50slides-30elem.html` (1500 nodes). New spec `perf-budget.spec.js` (5 tests): click-to-select p50/p95 latency, heap delta after 200 mutation cycles, selection-engine smoke, fixture sanity. Observed perf: p50≈17ms / p95≈100ms / heap delta ≈ 0MB. Phase 4 of 9 |
